...
<%
	...
	List<Store_reportVO> list = store_reportSvc.getAll();
...
<body class="bBody">
		...
		<div class="panel-group" id="accordion2" role="tablist"
			...
			<div class="panel panel-primary">
				...
				<div id="eee" class="panel-collapse collapse" role="tabpanel"
					...
					<div class="panel-body">
						<a href="reportProduct.html">商品檢舉管理</a>
					</div>
					<div class="panel-body">
	...
	<div class="col-xs-12 col-sm-10 bList">
		<div class="bListTitle">店家檢舉管理</div>
		<!-- Start of 主內容-->
			...
			<div>
				<table class="table table-hover table-bordered table-striped">
					...
					<%@ include file="page1.file" %>
						<c:forEach var="store_reportVO" items="${list}">
							<tr>
								<td>${store_reportVO.storepno}</td>
								<td>${storeSvc.getOneStore(store_reportVO.stono).stoname}</td>
								<td>${memberSvc.getOneMember(store_reportVO.memno).memname}</td>
								<td>${store_reportVO.repdate}</td>
								<td>${store_reportVO.reason}</td>
								<td>
									<form method="post"	action="<%=request.getContextPath()%>/store_report/store_report.do">										
										...
										<input type="hidden" name="storepno" value="${store_reportVO.storepno}">
										<input type="hidden" name="stono" value="${store_reportVO.stono}">
