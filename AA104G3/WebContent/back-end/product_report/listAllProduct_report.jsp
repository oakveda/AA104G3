...
<body class="bBody">
	...
	<div class="col-xs-12 col-sm-10 bList">
		<div class="bListTitle">商品檢舉管理</div>
		<!-- Start of 主內容-->
			...
			<div>
				<table class="table table-hover table-bordered table-striped">
					...
					<tbody>
						...
						<c:forEach var="prodcut_reportVO" items="${list}">
							<tr>
								...
								<td>
									<form method="post"	action="<%=request.getContextPath()%>/product_report/product_report.do">
										...
										<input type="hidden" name="prorepno"
											value="${prodcut_reportVO.prorepno}"> <input
											type="hidden" name="prono" value="${prodcut_reportVO.prono}">
										<input type="hidden" name="checked" value="2"> <input
									...
									<form method="post"
										...
										<button type="submit"
											class="btn btn-danger glyphicon glyphicon-remove">否決</button>
										<input type="hidden" name="prorepno"
											value="${prodcut_reportVO.prorepno}"> <input
											type="hidden" name="prono" value="${prodcut_reportVO.prono}">
										<input type="hidden" name="checked" value="1"> <input
											type="hidden" name="requestURL"
											value="<%=request.getServletPath()%>"> <input
											type="hidden" name="action" value="getOne_For_Update">
									</form>
		...
		<!-- End of 主內容 -->
		<hr>
		<div class="bFooter text-center">Get a Board ©2016 All rights
			reserved.</div>
	</div>
